...
public class PushNotificationsDevicePersistenceImpl extends BasePersistenceImpl<PushNotificationsDevice>
	...
	public List<PushNotificationsDevice> findByU(long[] userIds, int start,
		...
		if (list == null) {
			...
			if (userIds.length > 0) {
				...
				query.append(_FINDER_COLUMN_U_USERID_7);
	...
	private static final String _FINDER_COLUMN_U_USERID_7 = "pushNotificationsDevice.userId IN (";
	...
	public List<PushNotificationsDevice> findByU_AV(long[] userIds,
		...
		if (list == null) {
			...
			if (userIds.length > 0) {
				...
				query.append(_FINDER_COLUMN_U_AV_USERID_7);
	...
	private static final String _FINDER_COLUMN_U_AV_USERID_7 = "pushNotificationsDevice.userId IN (";
	 ...
	 */
	@Override
	public void removeByAppVersion(String appVersion) {
	 ...
	 */
	@Override
	public int countByAppVersion(String appVersion) {
